...
public class BussinessController {
  ...
  @GetMapping("test2")
  public ResponseEntity<Bussiness> test2() {
    return new ResponseEntity<>(Bussiness.builder().id("test").build(), HttpStatus.OK);
  }

  @GetMapping("test-error")
  public ResponseEntity<Bussiness> testError() {
    throw new CustomBussinessRuntimeException("message", "ErrorCode", "bussiness id");
  }
}
